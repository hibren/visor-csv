...
const data = [
  {
    ...
    value: 108,
    fill: "#16a34a",
    description: "Cree que la limpieza y el orden influyen en la delincuencia.",
  },
  {
    name: "No",
    value: 133,
    fill: "#ef4444",
    description:
      "No cree que la limpieza y el orden influyan en la delincuencia.",
  },
];
...
export default function LimpiezaOrdenDelincuenciaChart() {
  return (
    <div>
      <div className="mb-6 flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
        <div>
          <h2 className="text-xl font-bold text-gray-900">
            ¿Cree que la limpieza y el orden en su barrio influyen en la
            delincuencia?
          </h2>
